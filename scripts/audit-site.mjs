...
if (batch.generatedAt !== "2026-09-12") fail(`Publication manifest date must be 2026-09-12; found ${batch.generatedAt}.`);
if (batch.imageQa?.editorialImages !== 0 || batch.imageQa?.affiliateProductImages !== 0) fail("September 12 image QA must record 0 editorial and 0 affiliate/product images for the intentional image-free batch.");
...
for (const expected of ["mens-hair-dryer-buying-guide.html", "home-inventory-insurance-system.html", "indoor-rowing-machine-setup-technique-guide.html"]) if (!batchSlugs.has(expected)) fail(`September 12 manifest is missing ${expected}.`);
