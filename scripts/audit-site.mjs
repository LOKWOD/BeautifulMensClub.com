...
if (batch.generatedAt !== "2026-09-11") fail(`Publication manifest date must be 2026-09-11; found ${batch.generatedAt}.`);
if (batch.imageQa?.editorialImages !== 0 || batch.imageQa?.affiliateProductImages !== 0) fail("September 11 image QA must record 0 editorial and 0 affiliate/product images for the intentional image-free batch.");
...
for (const expected of ["mens-underwear-buying-guide.html", "mens-foot-care-routine.html", "how-to-give-a-toast.html"]) if (!batchSlugs.has(expected)) fail(`September 11 manifest is missing ${expected}.`);
